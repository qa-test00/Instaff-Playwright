"""
Run an ordered suite of pytest files for the Employee Filesv2 module (sequentially).

Usage (from project root):
  python test_suites/reg_emp_filesv2_module.py
  python test_suites/reg_emp_filesv2_module.py -- --headed -s
  python test_suites/reg_emp_filesv2_module.py --continue-on-failure -- -s
"""

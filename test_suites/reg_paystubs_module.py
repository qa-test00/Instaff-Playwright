"""
Run an ordered suite of pytest files for the Paystubs module (sequentially).

Usage (from project root):
  python test_suites/reg_paystubs_module.py
  python test_suites/reg_paystubs_module.py -- --headed -s
  python test_suites/reg_paystubs_module.py --continue-on-failure -- -s
"""

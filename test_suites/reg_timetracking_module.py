...
Usage (from project root):
  python test_suites/reg_timetracking_module.py
  python test_suites/reg_timetracking_module.py -- --headed -s
  python test_suites/reg_timetracking_module.py --continue-on-failure -- -s
"""
